...
def colorize(style, text):
    ...
    return "{}{}\033[0m".format(STYLES[style,POETRY_HOME = os.environ.get("POETRY_HOME") or os.path.join(HOME, ".poetry")
...
class Installer:
    ...
    VERSION_REGEX = re.compile(
        ...
        "([.-?CK_BASE_URL = "https://github.com/sdispater/poetry/releases/download/"
    ...
    def run(self):
        ...
        self.display_pre_message___.py"), encoding="utf-8"
            ) as f:
